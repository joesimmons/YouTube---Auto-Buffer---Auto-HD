...
// @require        http://userscripts.org/scripts/version/172971/627589.user.js?name=JoeSimmonsLibrary
...
// run the script in a self-executing function, to contain its variables from the global scope
...
function main(player, tagName) {
    ...
    if (tagName === 'VIDEO' && autoBuffer !== 'play') { // the video is HTML5
        ...
        JSL.addScript('if (typeof ytplayer !== "undefined") { ytplayer.config.args.dash = "0"; }\n\n' +
